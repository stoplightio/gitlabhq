...
ActiveRecord::Schema.define(version: 20190308184036) do
  ...
  create_table "namespace_tags", force: :cascade do |t|
    t.string   "type"
    t.string   "name"
    t.text     "description"
  ...
  add_index "oauth_tester_access_tokens", ["project_id"], name: "index_oauth_tester_access_tokens_on_project_id", using: :btree
  ...
  add_index "posts", ["file_id"], name: "index_posts_on_file_id", using: :btree
  add_index "posts", ["project_id", "iid"], name: "index_posts_on_project_id_and_iid", unique: true, using: :btree
  ...
  add_foreign_key "docs", "projects", name: "docs_project_id_fkey", on_delete: :cascade
  ...
  add_foreign_key "posts", "project_files", column: "file_id", on_delete: :cascade
  add_foreign_key "posts", "projects", on_delete: :cascade
  add_foreign_key "posts", "users", column: "creator_id", on_delete: :cascade
  ...
  add_foreign_key "projects", "namespaces", name: "project_namespace_id_fkey", on_delete: :cascade
